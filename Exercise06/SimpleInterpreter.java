...
public class SimpleInterpreter {
    ...
    private static double primaryValue() throws ParseError {
        ...
        if ( Character.isDigit(ch) ) {
			...
			if(symbolTable.get(name) instanceof StandardFunction){//is a standardFunction
				StandardFunction func = (StandardFunction)(symbolTable.get(name));
				return func.evaluate(primaryValue());
			}
			else{
